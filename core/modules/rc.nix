{
  programs.plasma = {
    ...
    shortcuts = {
      "ActivityManager"."switch-to-activity-a40a01bd-9b2a-4d4a-9efc-e8050e2a713d" = [ ];
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = [ ];
      "bismuth"."decrease_master_size" = "Meta+H";
      ...
      "bismuth"."focus_next_window" = "Meta+J";
      "bismuth"."focus_prev_window" = "Meta+K";
      "bismuth"."focus_right_window" = [ ];
      "bismuth"."focus_upper_window" = [ ];
      "bismuth"."increase_master_size" = "Meta+L";
      ...
      "bismuth"."move_window_to_next_pos" = "Meta+Down";
      "bismuth"."move_window_to_prev_pos" = "Meta+Up";
      ...
      "bismuth"."toggle_window_floating" = "Meta+Ctrl+T";
      ...
      "org_kde_powerdevil"."Decrease Keyboard Brightness" = ["Keyboard Brightness Down" "Alt+Monitor Brightness Down"];
      "org_kde_powerdevil"."Decrease Screen Brightness" = ["Monitor Brightness Down" "Meta+["];
      "org_kde_powerdevil"."Hibernate" = "Hibernate";
      "org_kde_powerdevil"."Increase Keyboard Brightness" = "Alt+Monitor Brightness Up";
      "org_kde_powerdevil"."Increase Screen Brightness" = ["Meta+]" "Monitor Brightness Up"];
    ...
    files = {
      ...
      "dolphinrc"."KPropertiesDialog"."eDP Height 1920x1080" = 603;
      "dolphinrc"."KPropertiesDialog"."eDP Width 1920x1080" = 504;
      "dolphinrc"."KPropertiesDialog"."eDP-1 Height 1920x1080" = 446;
      "dolphinrc"."KPropertiesDialog"."eDP-1 Width 1920x1080" = 406;
      ...
      "kactivitymanagerdrc"."activities"."a40a01bd-9b2a-4d4a-9efc-e8050e2a713d" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "a40a01bd-9b2a-4d4a-9efc-e8050e2a713d";
      "kcminputrc"."Keyboard"."RepeatDelay" = 200;
      "kcminputrc"."Libinput.1386.20995.Wacom HID 5203 Finger"."OutputName" = "eDP-1";
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Mouse"."NaturalScroll" = false;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Mouse"."PointerAcceleration" = 0.000;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Mouse"."PointerAccelerationProfile" = 2;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Mouse"."ScrollFactor" = 20;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Touchpad"."Enabled" = true;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Touchpad"."MiddleButtonEmulation" = false;
      "kcminputrc"."Libinput.1739.52656.MSFT0004:00 06CB:CDB0 Touchpad"."TapToClick" = true;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "963,599";
      "kdeglobals"."General"."AllowKDEAppsToRememberWindowPositions" = true;
      "kdeglobals"."General"."XftHintStyle" = "hintslight";
      "kdeglobals"."General"."XftSubPixel" = "rgb";
      "kdeglobals"."General"."fixed" = "Iosevka [UKWN],10,-1,5,57,0,0,0,0,0,Medium";
      "kdeglobals"."General"."font" = "Iosevka [UKWN],10,-1,5,63,0,0,0,0,0,Semibold";
      "kdeglobals"."General"."menuFont" = "Iosevka [UKWN],10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "Iosevka [UKWN],8,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "Iosevka [UKWN],10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."WM"."activeBackground" = "35,35,47";
      "kdeglobals"."WM"."activeBlend" = "59,62,68";
      "kdeglobals"."WM"."activeFont" = "Iosevka [UKWN],10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."WM"."activeForeground" = "221,221,221";
      "kdeglobals"."WM"."inactiveBackground" = "35,35,47";
      ...
      "khotkeysrc"."Data_10"."Comment" = "Comment";
      "khotkeysrc"."Data_10"."Enabled" = true;
      "khotkeysrc"."Data_10"."Name" = "CODE";
      "khotkeysrc"."Data_10"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_10Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_10Actions0"."CommandURL" = "code /home/archaict/Vault/File";
      "khotkeysrc"."Data_10Actions0"."Type" = "COMMAND_URL";
      "khotkeysrc"."Data_10Conditions"."Comment" = "";
      "khotkeysrc"."Data_10Conditions"."ConditionsCount" = 0;
      "khotkeysrc"."Data_10Triggers"."Comment" = "Simple_action";
      "khotkeysrc"."Data_10Triggers"."TriggersCount" = 1;
      "khotkeysrc"."Data_10Triggers0"."Key" = "Meta+C";
      "khotkeysrc"."Data_10Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_10Triggers0"."Uuid" = "{fdb4b77f-6eb2-4941-8b92-b267a10e82f7}";
      ...
      "khotkeysrc"."Data_1Triggers0"."Uuid" = "{af96550a6977060281337a1aaebff55e22051d2156eb18dd82ea045612884dfa}";
      ...
      "khotkeysrc"."Data_1_1Triggers0"."Uuid" = "{cce1b251-f552-4a1d-a878-276fd545ceb0}";
      "khotkeysrc"."Data_1_2"."Comment" = "After pressing Alt+Ctrl+H the input of 'Hello' will be simulated, as if you typed it.  This is especially useful if you have call to frequently type a word (for instance, 'unsigned').  Every keypress in the input is separated by a colon ':'. Note that the keypresses literally mean keypresses, so you have to write what you would press on the keyboard. In the table below, the left column shows the input and the right column shows what to type.\n\n\"enter\" (i.e. new line)                Enter or Return\na (i.e. small a)                          A\nA (i.e. capital a)                       Shift+A\n: (colon)                                  Shift+;\n' '  (space)                              Space";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{02b53d04-dc05-475c-9365-c89de9864899}";
      ...
      "khotkeysrc"."Data_2_3Actions0"."CommandURL" = "alacritty";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{d4dcac6a-e99f-4638-a235-ad02fdb8ec7a}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{8e402e84-7d55-4a0a-bede-b7a7c5e18bdf}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{cfd03f02-5132-4a09-baf0-0ccc1f32756e}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{84154987-518d-4d8a-bc21-c570da993b5f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{a6ede427-4a9c-4c93-b69c-512cc51022a6}";
      ...
      "khotkeysrc"."Data_4"."Comment" = "Alacritty\n";
      "khotkeysrc"."Data_4"."Enabled" = true;
      "khotkeysrc"."Data_4"."Name" = "Terminal";
      "khotkeysrc"."Data_4"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4Actions0"."CommandURL" = "alacrittm";
      ...
      "khotkeysrc"."Data_4Triggers0"."Key" = "Meta+Return";
      "khotkeysrc"."Data_4Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4Triggers0"."Uuid" = "{6c48500d-0186-4214-ba7b-a5a2a447ebce}";
      "khotkeysrc"."Data_5"."Comment" = "Comment";
      "khotkeysrc"."Data_5"."Enabled" = false;
      "khotkeysrc"."Data_5"."Name" = "Brightness Up";
      "khotkeysrc"."Data_5"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_5Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_5Actions0"."CommandURL" = "light -A 5";
      "khotkeysrc"."Data_5Actions0"."Type" = "COMMAND_URL";
      ...
      "khotkeysrc"."Data_5Triggers0"."Key" = "Monitor Brightness Up";
      "khotkeysrc"."Data_5Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_5Triggers0"."Uuid" = "{c3b92d1f-d117-4b42-b3be-690b2a0609f8}";
      "khotkeysrc"."Data_6"."Comment" = "Comment";
      "khotkeysrc"."Data_6"."Enabled" = false;
      "khotkeysrc"."Data_6"."Name" = "Brightness Down";
      "khotkeysrc"."Data_6"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_6Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_6Actions0"."CommandURL" = "light -U 5";
      ...
      "khotkeysrc"."Data_6Triggers0"."Key" = "Monitor Brightness Down";
      "khotkeysrc"."Data_6Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_6Triggers0"."Uuid" = "{69e72565-1950-4466-a1ec-4fc97f339bfd}";
      "khotkeysrc"."Data_7"."Comment" = "Comment";
      "khotkeysrc"."Data_7"."Enabled" = false;
      "khotkeysrc"."Data_7"."Name" = "Brightness Up";
      "khotkeysrc"."Data_7"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_7Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_7Actions0"."CommandURL" = "light -A 5";
      "khotkeysrc"."Data_7Actions0"."Type" = "COMMAND_URL";
      "khotkeysrc"."Data_7Conditions"."Comment" = "";
      "khotkeysrc"."Data_7Conditions"."ConditionsCount" = 0;
      "khotkeysrc"."Data_7Triggers"."Comment" = "Simple_action";
      "khotkeysrc"."Data_7Triggers"."TriggersCount" = 1;
      "khotkeysrc"."Data_7Triggers0"."Key" = "Meta+]";
      "khotkeysrc"."Data_7Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_7Triggers0"."Uuid" = "{898087e8-b62c-4933-b774-99a398cf5cfa}";
      "khotkeysrc"."Data_8"."Comment" = "Comment";
      "khotkeysrc"."Data_8"."Enabled" = false;
      "khotkeysrc"."Data_8"."Name" = "Brightness Down";
      "khotkeysrc"."Data_8"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_8Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_8Actions0"."CommandURL" = "light -U 5";
      "khotkeysrc"."Data_8Actions0"."Type" = "COMMAND_URL";
      "khotkeysrc"."Data_8Conditions"."Comment" = "";
      "khotkeysrc"."Data_8Conditions"."ConditionsCount" = 0;
      "khotkeysrc"."Data_8Triggers"."Comment" = "Simple_action";
      "khotkeysrc"."Data_8Triggers"."TriggersCount" = 1;
      "khotkeysrc"."Data_8Triggers0"."Key" = "Meta+[";
      "khotkeysrc"."Data_8Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_8Triggers0"."Uuid" = "{6959c68d-657e-463e-b36f-4f35f591b45b}";
      "khotkeysrc"."Data_9"."Comment" = "Comment";
      "khotkeysrc"."Data_9"."Enabled" = true;
      "khotkeysrc"."Data_9"."Name" = "Vivaldi";
      "khotkeysrc"."Data_9"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_9Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_9Actions0"."CommandURL" = "vivaldi";
      "khotkeysrc"."Data_9Actions0"."Type" = "COMMAND_URL";
      "khotkeysrc"."Data_9Conditions"."Comment" = "";
      "khotkeysrc"."Data_9Conditions"."ConditionsCount" = 0;
      "khotkeysrc"."Data_9Triggers"."Comment" = "Simple_action";
      "khotkeysrc"."Data_9Triggers"."TriggersCount" = 1;
      "khotkeysrc"."Data_9Triggers0"."Key" = "Meta+I";
      "khotkeysrc"."Data_9Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_9Triggers0"."Uuid" = "{dc7be264-5001-42dd-b01e-33c8e881ce99}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/archaict/Vault/Pictures/Landscape/iceberg1.jpg";
      ...
      "kwinrc"."Desktops"."Id_1" = "ed190533-f5e1-4422-bea0-c97282710613";
      "kwinrc"."Desktops"."Id_2" = "fca5d3bd-5cff-4309-bf8f-ea400f2df518";
      "kwinrc"."Desktops"."Id_3" = "a194fdad-b0ed-4b94-beef-52c40ffa8fa7";
      "kwinrc"."Desktops"."Id_4" = "16a94fee-2d48-4c46-9c07-afa5823d9e05";
      "kwinrc"."Desktops"."Id_5" = "057dff8b-3e6e-4a29-9b76-123ffcd6807a";
      "kwinrc"."Desktops"."Name_1" = "Home";
      "kwinrc"."Desktops"."Name_2" = "Work";
      "kwinrc"."Desktops"."Name_3" = "Univ";
      "kwinrc"."Desktops"."Name_4" = "Other";
      "kwinrc"."Desktops"."Name_5" = "Settings";
      "kwinrc"."Desktops"."Number" = 5;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-PresentWindows"."TouchBorderActivateAll" = "0,4";
      ...
      "kwinrc"."Plugins"."selective-virtual-desktopsEnabled" = false;
      ...
      "kwinrc"."Script-bismuth"."screenGapBottom" = 8;
      "kwinrc"."Script-bismuth"."screenGapLeft" = 8;
      "kwinrc"."Script-bismuth"."screenGapRight" = 8;
      "kwinrc"."Script-bismuth"."screenGapTop" = 8;
      "kwinrc"."Script-bismuth"."tileLayoutGap" = 8;
      "kwinrc"."Script-selective-virtual-desktops"."enabledDisplays" = "XWAYLAND0";
      ...
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."Description" = "Settings for *";
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."opacityactive" = 80;
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."opacityactiverule" = 2;
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."opacityinactive" = 70;
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."opacityinactiverule" = 2;
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."wmclass" = "*";
      "kwinrulesrc"."02869d73-83e2-4fb7-8e64-9a191c838e5d"."wmclassmatch" = 3;
      "kwinrulesrc"."1"."Description" = "Application settings for systemsettings";
      "kwinrulesrc"."1"."clientmachine" = "localhost";
      "kwinrulesrc"."1"."desktops" = "057dff8b-3e6e-4a29-9b76-123ffcd6807a";
      "kwinrulesrc"."1"."opacityactive" = 90;
      "kwinrulesrc"."1"."opacityactiverule" = 2;
      "kwinrulesrc"."1"."opacityinactive" = 90;
      "kwinrulesrc"."1"."opacityinactiverule" = 2;
      "kwinrulesrc"."1"."title" = "Univ - Visual Studio Code";
      "kwinrulesrc"."1"."wmclass" = "systemsettings";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."2"."Description" = "Application settings for org.kde.dolphin";
      "kwinrulesrc"."2"."clientmachine" = "localhost";
      "kwinrulesrc"."2"."desktops" = "057dff8b-3e6e-4a29-9b76-123ffcd6807a";
      "kwinrulesrc"."2"."ignoregeometry" = true;
      "kwinrulesrc"."2"."opacityactive" = 90;
      "kwinrulesrc"."2"."opacityactiverule" = 2;
      "kwinrulesrc"."2"."opacityinactive" = 74;
      "kwinrulesrc"."2"."opacityinactiverule" = 2;
      "kwinrulesrc"."2"."title" = "Univ - Visual Studio Code";
      "kwinrulesrc"."2"."wmclass" = "dolphin org.kde.dolphin";
      "kwinrulesrc"."2"."wmclasscomplete" = true;
      "kwinrulesrc"."2"."wmclassmatch" = 1;
      "kwinrulesrc"."3"."Description" = "Window settings for systemsettings";
      "kwinrulesrc"."3"."below" = true;
      "kwinrulesrc"."3"."clientmachine" = "localhost";
      "kwinrulesrc"."3"."desktops" = "057dff8b-3e6e-4a29-9b76-123ffcd6807a";
      "kwinrulesrc"."3"."desktopsrule" = 2;
      "kwinrulesrc"."3"."ignoregeometry" = true;
      "kwinrulesrc"."3"."title" = "Univ - Visual Studio Code";
      "kwinrulesrc"."3"."types" = 1;
      "kwinrulesrc"."3"."wmclass" = "systemsettings";
      "kwinrulesrc"."3"."wmclassmatch" = 1;
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."Description" = "Window settings for code";
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."clientmachine" = "localhost";
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."desktops" = "a194fdad-b0ed-4b94-beef-52c40ffa8fa7";
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."desktopsrule" = 2;
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."title" = "Univ - Visual Studio Code";
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."titlematch" = 2;
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."types" = 1;
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."wmclass" = "code";
      "kwinrulesrc"."3b133243-33a4-481e-86b1-b4b71c899100"."wmclassmatch" = 1;
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."Description" = "Window settings for code";
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."clientmachine" = "localhost";
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."desktops" = "fca5d3bd-5cff-4309-bf8f-ea400f2df518";
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."desktopsrule" = 2;
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."title" = "Work - Visual Studio Code";
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."titlematch" = 2;
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."types" = 1;
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."wmclass" = "code";
      "kwinrulesrc"."3d516fde-a124-4fcc-9d9d-1200ae0895a8"."wmclassmatch" = 1;
      "kwinrulesrc"."4"."Description" = "Window settings for code";
      "kwinrulesrc"."4"."below" = true;
      "kwinrulesrc"."4"."clientmachine" = "localhost";
      "kwinrulesrc"."4"."desktops" = "a194fdad-b0ed-4b94-beef-52c40ffa8fa7";
      "kwinrulesrc"."4"."desktopsrule" = 2;
      "kwinrulesrc"."4"."ignoregeometry" = true;
      "kwinrulesrc"."4"."title" = "Univ - Visual Studio Code";
      "kwinrulesrc"."4"."titlematch" = 2;
      "kwinrulesrc"."4"."types" = 1;
      "kwinrulesrc"."4"."wmclass" = "code";
      "kwinrulesrc"."4"."wmclassmatch" = 1;
      "kwinrulesrc"."46a52cb8-b098-422e-a303-a23c4c67933f"."Description" = "Application settings for systemsettings";
      "kwinrulesrc"."46a52cb8-b098-422e-a303-a23c4c67933f"."strictgeometryrule" = 2;
      "kwinrulesrc"."46a52cb8-b098-422e-a303-a23c4c67933f"."wmclass" = "systemsettings";
      "kwinrulesrc"."46a52cb8-b098-422e-a303-a23c4c67933f"."wmclassmatch" = 1;
      "kwinrulesrc"."5"."Description" = "Window settings for code";
      "kwinrulesrc"."5"."below" = true;
      "kwinrulesrc"."5"."clientmachine" = "localhost";
      "kwinrulesrc"."5"."desktops" = "fca5d3bd-5cff-4309-bf8f-ea400f2df518";
      "kwinrulesrc"."5"."desktopsrule" = 2;
      "kwinrulesrc"."5"."ignoregeometry" = true;
      "kwinrulesrc"."5"."title" = "Work - Visual Studio Code";
      "kwinrulesrc"."5"."titlematch" = 2;
      "kwinrulesrc"."5"."types" = 1;
      "kwinrulesrc"."5"."wmclass" = "code";
      "kwinrulesrc"."5"."wmclassmatch" = 1;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."Description" = "Application settings for org.kde.dolphin";
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."opacityactive" = 90;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."opacityactiverule" = 2;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."opacityinactive" = 90;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."opacityinactiverule" = 2;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."wmclass" = "dolphin org.kde.dolphin";
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."wmclasscomplete" = true;
      "kwinrulesrc"."5537a953-0bc1-4723-91e2-4b2ee56100b6"."wmclassmatch" = 1;
      "kwinrulesrc"."6"."Description" = "Window settings for code";
      "kwinrulesrc"."6"."below" = true;
      "kwinrulesrc"."6"."clientmachine" = "localhost";
      "kwinrulesrc"."6"."desktops" = "ed190533-f5e1-4422-bea0-c97282710613";
      "kwinrulesrc"."6"."desktopsrule" = 2;
      "kwinrulesrc"."6"."ignoregeometry" = true;
      "kwinrulesrc"."6"."title" = "Personal - Visual Studio Code";
      "kwinrulesrc"."6"."titlematch" = 2;
      "kwinrulesrc"."6"."types" = 1;
      "kwinrulesrc"."6"."wmclass" = "code";
      "kwinrulesrc"."6"."wmclassmatch" = 1;
      "kwinrulesrc"."7"."Description" = "Application settings for systemsettings";
      "kwinrulesrc"."7"."below" = true;
      "kwinrulesrc"."7"."clientmachine" = "localhost";
      "kwinrulesrc"."7"."ignoregeometry" = true;
      "kwinrulesrc"."7"."ignoregeometryrule" = 2;
      "kwinrulesrc"."7"."strictgeometryrule" = 2;
      "kwinrulesrc"."7"."title" = "Personal - Visual Studio Code";
      "kwinrulesrc"."7"."wmclass" = "systemsettings";
      "kwinrulesrc"."7"."wmclassmatch" = 3;
      "kwinrulesrc"."8"."Description" = "Rofi";
      "kwinrulesrc"."8"."below" = true;
      "kwinrulesrc"."8"."belowrule" = 2;
      "kwinrulesrc"."8"."wmclass" = "rofi";
      "kwinrulesrc"."8"."wmclasscomplete" = true;
      "kwinrulesrc"."8"."wmclassmatch" = 1;
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."Description" = "Application settings for systemsettings";
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."opacityactive" = 90;
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."opacityactiverule" = 2;
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."opacityinactive" = 90;
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."opacityinactiverule" = 2;
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."wmclass" = "systemsettings";
      "kwinrulesrc"."8ab4e851-d58d-4115-b68d-f7a6d192eb48"."wmclassmatch" = 1;
      "kwinrulesrc"."9"."Description" = "Settings for *";
      "kwinrulesrc"."9"."opacityactive" = 80;
      "kwinrulesrc"."9"."opacityactiverule" = 2;
      "kwinrulesrc"."9"."opacityinactive" = 70;
      "kwinrulesrc"."9"."opacityinactiverule" = 2;
      "kwinrulesrc"."9"."wmclass" = "*";
      "kwinrulesrc"."9"."wmclassmatch" = 3;
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."Description" = "Rofi";
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."below" = true;
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."belowrule" = 2;
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."wmclass" = "Rofi";
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."wmclasscomplete" = true;
      "kwinrulesrc"."93cadd54-5af3-433a-8691-7f4d5cc34c62"."wmclassmatch" = 1;
      "kwinrulesrc"."99ca9693-6ed9-4cb9-9df5-a9bfca878e46"."Description" = "New window settings";
      "kwinrulesrc"."99ca9693-6ed9-4cb9-9df5-a9bfca878e46"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 10;
      "kwinrulesrc"."General"."rules" = "f27cc51c-b41b-4817-9cdf-ef78c60ab199,1,2,3,4,5,6,7,8,9";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."Description" = "Window settings for code";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."clientmachine" = "localhost";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."desktops" = "ed190533-f5e1-4422-bea0-c97282710613";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."desktopsrule" = 2;
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."title" = "Personal - Visual Studio Code";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."titlematch" = 2;
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."types" = 1;
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."wmclass" = "code";
      "kwinrulesrc"."eeb8310e-ca26-483d-8ecd-91b9be60674e"."wmclassmatch" = 1;
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."Description" = "Application settings for code";
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."clientmachine" = "localhost";
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."opacityactive" = 90;
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."opacityactiverule" = 2;
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."opacityinactive" = 90;
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."opacityinactiverule" = 2;
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."wmclass" = "code";
      "kwinrulesrc"."f27cc51c-b41b-4817-9cdf-ef78c60ab199"."wmclassmatch" = 1;
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."Description" = "Window settings for systemsettings";
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."desktops" = "057dff8b-3e6e-4a29-9b76-123ffcd6807a";
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."desktopsrule" = 2;
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."types" = 1;
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."wmclass" = "systemsettings";
      "kwinrulesrc"."f37f7f69-6420-49ac-a764-5d99923c4ca7"."wmclassmatch" = 1;
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."Description" = "Window settings for qemu";
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."above" = true;
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."aboverule" = 2;
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."title" = "QEMU (endeavouros-apollo_22_1)";
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."types" = 1;
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."wmclass" = "qemu-system-x86_64 qemu";
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."wmclasscomplete" = true;
      "kwinrulesrc"."f937693c-9b7c-4635-9119-a9e172f50c4b"."wmclassmatch" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Theme"."name" = "We10XOS-dark";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/archaict/Vault/Pictures/Minimal/nasa.png,/home/archaict/Vault/Pictures/Landscape/water.jpg,/home/archaict/Vault/Pictures/Landscape/ultraviolet.jpg,/home/archaict/Vault/Pictures/Landscape/tokyo.jpg,/home/archaict/Vault/Pictures/Landscape/sea.jpg,/home/archaict/Vault/Pictures/Landscape/mountain.jpg,/home/archaict/Vault/Pictures/Landscape/iceland-sea.jpg,/home/archaict/Vault/Pictures/Landscape/iceberg4.jpg,/home/archaict/Vault/Pictures/Landscape/iceberg3.jpg,/home/archaict/Vault/Pictures/Landscape/iceberg2.jpg,/home/archaict/Vault/Pictures/Landscape/iceberg.jpg,/home/archaict/Vault/Pictures/Landscape/continuation_of_dream.jpg,/home/archaict/Vault/Pictures/Landscape/iceberg1.jpg";
      "systemsettingsrc"."KFileDialog Settings"."detailViewIconSize" = 16;
      "systemsettingsrc"."KPropertiesDialog"."eDP Height 1920x1080" = 470;
      "systemsettingsrc"."KPropertiesDialog"."eDP Width 1920x1080" = 413;
    };
  };
}
